...
export function activate(context: vscode.ExtensionContext) {
	...
	vscode.commands.registerCommand('rulebooks.editRulebook', (node: RulebookFile) => vscode.commands.executeCommand("vscode.open", vscode.Uri.file(node.filepath)));
	...
	vscode.commands.registerCommand('configFiles.refreshConfigFiles', (rulebook: Rulebook) => configFileProvider.refresh(rulebook.Files));
	vscode.commands.registerCommand('configFiles.addConfigFile', () => vscode.window.showInformationMessage(`Added new configFile.`));
	vscode.commands.registerCommand('configFiles.editConfigFile', (node: ConfigFile) => vscode.commands.executeCommand("vscode.open", vscode.Uri.file(node.filepath)));
